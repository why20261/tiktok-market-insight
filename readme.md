...
> **前置（只需做一次）**：通过微信 `13395823479`（备注"TikTok 技能"）申请 Token，或到 [TikTok市场趋势洞察技能官网](https://www.guaikei.com) 自助开通，然后配置环境变量：
>
> ```bash
> # Windows
...
- **开通**：微信 `13395823479`（备注"TikTok 技能"），或 [TikTok市场洞察](https://www.guaikei.com) 自助开通。
